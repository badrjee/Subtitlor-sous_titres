...
<body>
	...
	<a class="btn" style="position:fixed; top: 90px; right: 100px;" href="/Subtitlor/home">acceuil</a>
    
    <form method="post" action="/Subtitlor/edit?file=${ fileName }">    
        <input class="btn" type="submit" value="Enregistrer" style="position:fixed; top: 150px; right: 100px;"/>
        <%-- Display the download link only if there's a translation --%>
        <c:if test="${ !empty newFile || !empty translatedFiless }">
        	<a class="btn" style="position:fixed; top: 190px; right: 100px;" href="/Subtitlor/download">Télécharger</a>
	    </c:if>
	    <table>
